                        ...
                        while (menuComercial != 8) {
                            ...
                            switch (menuComercial) {
                                case 1: {
                                    ...
                                    String nomComAux = teclado.nextLine();
                                    System.out.println("Dime el apellido 1 del comercial: ");
                                    String apeComAux = teclado.nextLine();
                                    System.out.println("Dime el apellido 2 del comercial: ");
                                    String ape2ComAux = teclado.nextLine();
                                    System.out.println("Dime la comision del comerical: ");
                                    float comisionAux = teclado.nextFloat();
